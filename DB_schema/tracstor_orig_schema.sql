...
BEGIN
    FOR mviews in
		(select * from jsonb_array_elements('[{"platform": "Frigate", "serial": "EX_ALPHA", "sensor": "GPS", "heading": 0, "course": "", "speed": "", "source": "CD_123", "privacy": "public", "depth": "", "es_index": "states"}]'))
	LOOP
...
CREATE FUNCTION public.insert_from_json(in_json_txt json) RETURNS void
  ...
  SELECT (rec->>'platform')::text , (rec->>'serial')::text  FROM
